...
module.exports = {
  ...
  alc: JS.addons,
  faqs: [
    { q: 'Will it sound robotic?', a: 'Callers hear a calm, professional voice with natural pacing — most never realise it\'s AI until we tell them. You approve the voice, greeting and scripts before we go live, and you can listen to real recordings from your dashboard any time.' },
    ...
    { q: 'Is it compliant? Consent and TCPA?', a: 'Every consent-critical interaction carries a TCPA proof trail — consent capture, disclosure and revocation handling are configured before any campaign goes live. Governance isn\'t a policy PDF: permission scopes, approval gates and audit trails are built into the substrate itself.' },
