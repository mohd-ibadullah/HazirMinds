...
module.exports = [
  {
    ...
    services: [
      ...
      { n: '06', slug: 'ai-support-agent', name: 'AI Support Agent', outcome: 'Tier-1 support resolved instantly and accurately, with humans handling only what matters.', points: ['Resolves common tickets on first touch', 'Deflects volume, raises satisfaction', 'Seamless handoff with full context'], gov: 'Low-confidence disclosure + escalation, always.' },
      ...
      { n: '08', slug: 'dfy-snapshots', name: 'Done-For-You Snapshots', outcome: 'Proven, pre-built automations for your industry, deployed and customised in days.', points: ['Battle-tested workflows per industry', 'Customised to your exact process', 'Live in under two weeks'], gov: null },
      { n: '09', slug: 'managed-hosting', name: 'Managed Hosting & Maintenance', outcome: 'The infrastructure your agents live on — monitored, patched and backed up by us.', points: ['Continuous operation — monitored 24/7', 'Security patches and monitoring', 'Daily backups, one-click restore'], gov: 'Isolated per-client environments on the substrate.' }
    ]
  },
  {
  ...
  },
  {
    ...
    services: [
      ...
      { n: '37', slug: 'database-reactivation', name: 'Database Reactivation', outcome: 'Your old leads are a goldmine — campaigns that re-open stalled conversations and book them again.', points: ['Segmented win-back campaigns', 'Offer testing and response tracking', 'Priced as performance: base + per booking'], gov: null },
      { n: '38', slug: 'consent-tcpa-trail', name: 'Consent & TCPA Proof Trail', outcome: 'Every consent captured, timestamped and provable — the compliance receipt you hope you never need.', points: ['Consent capture per channel', 'Timestamped, exportable trail', 'Aligned to TCPA expectations'], gov: null },
      { n: '39', slug: 'compliance-scoring', name: 'Compliance Scoring', outcome: 'A standing score for your AI risk, consent and audit posture — tracked, not guessed.', points: ['8-dimension governance score', 'Trend tracked month over month', 'Fix list prioritised by risk'], gov: null },
      { n: '40', slug: 'vertical-agents', name: 'Vertical Agents', outcome: 'Photo-estimate, dispatch and live-translation agents for the trades that need them.', points: ['Photo-estimate intake', 'Dispatch coordination', 'Live translation on calls'], gov: null }
    ]
  }
];
